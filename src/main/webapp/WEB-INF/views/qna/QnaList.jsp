...
<%-- ===============================
     ✅ (뷰 확인용) 더미 데이터
     컨트롤러에서 tagTop15, qnaList, pageInfo 내려주면 이 블록 제거
     - qnaList: qna_id, title, tagName, likeCount, answerCount, createdAt, preview(본문 일부)
     =============================== --%>
<%
  ...
  if (request.getAttribute("qnaList") == null) {
    ...
    for (int i=1; i<=18; i++) {
      ...
      q.put("createdAt", "1분 전");
      q.put("preview", "질문 본문 미리보기 예시 텍스트 " + i + " — 카드/앨범 뷰에서만 노출됩니다. 내용이 길면 자동으로 줄임 처리됩니다.");
      qnaList.add(q);
    }
            ...
            <a class="qna-row qna-row--body"
              ...
              <div class="cell cell-title">
                ...
                <span class="meta-line">
                  ...
                  <span class="meta-date"><c:out value="${q.createdAt}"/></span>
                </span>
              </div>
              ...
              <div class="cell cell-date"><c:out value="${q.createdAt}"/></div>
            </a>
          </c:forEach>
        </div>
      </section>
