...
public interface ShoppingCartService {
	public int addWishList(int user_id, int product_id) throws DuplicateKeyException;	// 찜목록에 추가
	...
	public int deleteAllCart(int user_id) throws Exception;						// 장바구니초기화
	public int deleteAllWish(int user_id) throws Exception;						// 찜목록 초기화
	
	public int moveToCart(int user_id, int product_id) throws Exception;		// 찜목록에서 장바구니로 이동
}
